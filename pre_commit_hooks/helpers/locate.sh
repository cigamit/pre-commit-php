...
local_src_command="src/$local_command"
prefixed_local_src_command="php $local_src_command"
...
if [ -f "$vendor_command" ]; then
    ...
    exec_command=$prefixed_local_src_command
elif [ -f "$local_src_command" ]; then
